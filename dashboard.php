...
<head>
    ...
    <meta name="theme-color" content="#2b4159">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-primary text-light">
                                                <div class="stat-panel text-center">
                                                    <div class="stat-panel-number h1 ">Apply for Rez</div>
                                                </div>
                                            </div>
                                            <a href="pgi/index.php" class="block-anchor panel-footer">Full Detail <i
                                                    class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-success text-light">
                                                <div class="stat-panel text-center">
                                                    <div class="stat-panel-number h1 ">Upload CV</div>
                                                </div>
                                            </div>
                                            <a href="CVs.php" class="block-anchor panel-footer text-center">See All
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body bk-success text-light">
                                                <div class="stat-panel text-center">
                                                    ...
                                                    <div class="stat-panel-number h1 ">Rent off Campus</div>

                                                </div>
                                            </div>
                                            <a href="offrez.php" class="block-anchor panel-footer text-center">See All
                                                &nbsp; <i class="fa fa-arrow-right"></i></a>
                                        </div>
                                    </div>
